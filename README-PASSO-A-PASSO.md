# Academia Olitech v2 - Passo a passo
...
## Observação
A v2 funciona em modo localStorage se o Supabase não for configurado. Com Supabase configurado, o sistema fica preparado para evoluir para persistência online completa.
